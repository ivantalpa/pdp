...
int main(int argc, char *argv[]) {
    ...
    if (myrank == root) {
        ...
        // Exemplu 6.1 (Curs Moodle)
        /*
        A[0] = 400; A[1] = 0; A[2] = 0; A[3] = 0; A[4] = 0; A[5] = 0;
        A[6] = 300; A[7] = 300; A[8] = 0; A[9] = 0; A[10] = 0; A[11] = 0;
        A[12] = 200; A[13] = 200; A[14] = 200; A[15] = 0; A[16] = 0; A[17] = 0;
        A[18] = 100; A[19] = 100; A[20] = 100; A[21] = 100; A[22] = 0; A[23] = 0;
        A[24] = 0; A[25] = 0; A[26] = 0; A[27] = 0; A[28] = 0; A[29] = 0;
        A[30] = -100; A[31] = -100; A[32] = -100; A[33] = -100; A[34] = -100; A[35] = -100;

        B[0] = 0; B[1] = 200; B[2] = 100;
        B[3] = 0; B[4] = -100; B[5] = -200;
        B[6] = 0; B[7] = 0; B[8] = 100;
        B[9] = 0; B[10] = -100; B[11] = -200;
        B[12] = 0; B[13] = 0; B[14] = 0;
        B[15] = 0; B[16] = -100; B[17] = -200;
        B[18] = 0; B[19] = 0; B[20] = 0;
        B[21] = 0; B[22] = -100; B[23] = -200;
        B[24] = 0; B[25] = 0; B[26] = 0;
        B[27] = 0; B[28] = 0; B[29] = -200;
        B[30] = 0; B[31] = 0; B[32] = 0;
        B[33] = 0; B[34] = 0; B[35] = 0;
        */
